/* gate_1006.mjs — the printed contract shows all of its own words (build 1006).
   ...
   Usage: node gate_1006.mjs [path] — previous build = negative control; must go
