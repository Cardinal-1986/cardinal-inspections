...
const MATRIX=[
  ...
  ['production', {Sell:true,  Insurance:false, Production:false, Community:true }],
  ['community',  {Sell:true,  Insurance:false, Production:true,  Community:false}],
  ['sales',      {Sell:false, Insurance:false, Production:true,  Community:true }],
];
