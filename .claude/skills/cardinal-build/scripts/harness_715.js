/* Gate for build 715 — the PO badge must stop rewriting the client profile every frame.
 *
 ...
 *   node harness_715.js index.html            -> PASS
 *   node harness_715.js index_prev714.html    -> FAIL
 */
const fs = require('fs');
