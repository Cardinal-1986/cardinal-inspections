/* Gate for build 715 — AI Estimate must reach the client, and carry them to the API.
 *
 ...
 *
 * Negative control — MUST go red on build 714:
 *   node harness715.js index.html          -> PASS
 *   node harness715.js index_prev714.html  -> FAIL
 */
const fs = require('fs');
