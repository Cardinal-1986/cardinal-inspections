/* gate_1031.mjs — the printed contract shows all of its own words (build 1031).
   ...
   Usage: node gate_1031.mjs [path] — previous build = negative control; must go
