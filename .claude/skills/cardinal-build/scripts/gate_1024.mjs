/* gate_1024.mjs — the printed contract shows all of its own words (build 1024).
   ...
   Usage: node gate_1024.mjs [path] — previous build = negative control; must go
