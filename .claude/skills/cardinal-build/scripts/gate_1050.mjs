/* gate_1050.mjs — the printed contract shows all of its own words (build 1050).
   ...
   Usage: node gate_1050.mjs [path] — previous build = negative control; must go
