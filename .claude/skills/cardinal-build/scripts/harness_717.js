/* Gate for build 717 — the Templates button must open templates, not the AI screen.
 *
 ...
 *   node harness_717.js index.html          -> PASS
 *   node harness_717.js index_prev716.html  -> FAIL
 */
const fs = require('fs');
