/* Gate for build 717 — a non-admin's sign-in must actually be recorded.
 *
 ...
 * policy is is_admin(). Build 716 asks; build 717 does not.
 *
 * Negative control — MUST go red on build 716:
 *   node harness717.js index.html          -> PASS
 *   node harness717.js index_prev716.html  -> FAIL
 */
const fs = require('fs');
